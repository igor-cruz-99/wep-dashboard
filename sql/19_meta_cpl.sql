-- ============================================================================
-- META DE CPL — roda DEPOIS do 12_meta_investimento.sql.
--
-- Card CPL passa a ter meta (barra + %atingimento), como os outros.
-- Valor vem de wep_tags.meta_cpl (você já preencheu).
--
-- ⚠️ vw_tags foi criada com `select *` e congela as colunas → recriar para ela
--    enxergar meta_cpl, senão a fn_kpis falha.
-- ============================================================================
alter table mkt_wep.wep_tags add column if not exists meta_cpl numeric;
